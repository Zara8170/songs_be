...
import com.example.song_be.domain.member.service.SocialService;
...
public class SocialController {
    ...
    private LoginResponseDTO getSocialLoginResponseDTO(HttpServletResponse response, Map<String, Object> loginClaims) {
        ...
        log.info("loginClaims: {}", loginClaims);
        ...
        LoginResponseDTO loginResponseDTO = LoginResponseDTO.builder()
                ...
                .nickname(String.valueOf(Optional.ofNullable(loginClaims.get("nickname")).orElse("소셜회원")))
